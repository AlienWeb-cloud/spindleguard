    ...
    private var stepBody: some View {
        ...
        case 0:
            VStack(alignment: .leading, spacing: 10) {
                ...
                Text("It refuses /Volumes and /dev. It never deletes files. There is no deletion bucket.")
        ...
        default:
            VStack(alignment: .leading, spacing: 10) {
                Text("Disposable session")
                    .font(.headline)
                Text("Creates a retained source and mount under the session parent. Files are not deleted. After Finish you can Start from Broker when this Mac can mount.")
                    .foregroundStyle(.secondary)
